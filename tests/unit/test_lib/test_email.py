...
class TestEmailServiceInitialization:
    ...
    def test_jinja_environment_setup(self, email_service):
...
class TestSMTPConnection:
    ...
    def test_smtp_connection_disabled(self, mock_settings):
    ...
    @patch("smtplib.SMTP")
    def test_smtp_connection_success(self, mock_smtp_class, email_service):
    ...
    def test_smtp_ssl_connection(self, mock_smtp_ssl_class, mock_settings):
    ...
    @patch("smtplib.SMTP")
    def test_smtp_connection_without_credentials(self, mock_smtp_class, mock_settings):
    ...
    @patch("smtplib.SMTP")
    def test_smtp_connection_failure(self, mock_smtp_class, email_service):
...
class TestSendEmail:
    ...
    async def test_send_email_disabled(self, mock_connection, mock_settings):
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_no_connection(self, mock_connection, email_service):
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_success(self, mock_connection, email_service):
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_multiple_recipients(self, mock_connection, email_service):
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_auto_text_generation(self, mock_connection, email_service):
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_smtp_exception(self, mock_connection, email_service):
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_custom_sender(self, mock_connection, email_service):
...
class TestTemplateEmail:
    ...
    @patch.object(EmailService, "send_email")
    async def test_send_template_email_with_text_template(self, mock_send, email_service):
    ...
    @patch.object(EmailService, "send_email")
    async def test_send_template_email_template_error(self, mock_send, email_service):
...
class TestSpecificEmailTypes:
    """Test specific email types (verification, welcome, etc.)."""

    @patch.object(EmailService, "send_template_email")
    async def test_send_verification_email_with_template(self, mock_send_template, email_service, test_user):
    ...
    @patch.object(EmailService, "send_template_email")
    @patch.object(EmailService, "send_email")
    async def test_send_verification_email_fallback(self, mock_send, mock_send_template, email_service, test_user):
    ...
    @patch.object(EmailService, "send_template_email")
    async def test_send_welcome_email(self, mock_send_template, email_service, test_user):
    ...
    @patch.object(EmailService, "send_template_email")
    async def test_send_password_reset_email(self, mock_send_template, email_service, test_user):
    ...
    @patch.object(EmailService, "send_template_email")
    async def test_send_password_reset_confirmation_email(self, mock_send_template, email_service, test_user):
    ...
    @patch.object(EmailService, "send_template_email")
    async def test_send_team_invitation_email(self, mock_send_template, email_service):
    ...
    @patch.object(EmailService, "send_template_email")
    @patch.object(EmailService, "send_email")
    async def test_send_team_invitation_email_fallback(self, mock_send, mock_send_template, email_service):
...
class TestEmailServiceEdgeCases:
    ...
    @patch.object(EmailService, "_create_smtp_connection")
    async def test_send_email_with_empty_recipients(self, mock_connection, email_service):
    ...
    async def test_user_without_name_in_verification_email(self, email_service):
