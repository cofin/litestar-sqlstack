...
def test_connection_success(mock_settings: MagicMock) -> None:
    runner = CliRunner()
...
def test_connection_failed(mock_settings: MagicMock) -> None:
    runner = CliRunner()
    with patch("tools.postgres.cli.connection.get_settings", return_value=mock_settings), \
...
def test_create_db_already_exists(mock_settings: MagicMock) -> None:
    runner = CliRunner()
    mock_conn = MagicMock()
    mock_cur = MagicMock()
...
def test_create_db_success(mock_settings: MagicMock) -> None:
    runner = CliRunner()
    mock_conn = MagicMock()
    mock_cur = MagicMock()
...
def test_drop_db_success(mock_settings: MagicMock) -> None:
    runner = CliRunner()
    mock_conn = MagicMock()
    mock_conn.__enter__.return_value = mock_conn
...
def test_health_success(mock_settings: MagicMock) -> None:
    runner = CliRunner()
