...
@click.option("--superuser", help="Create as a superuser", type=click.BOOL, default=False, required=False, show_default=False, is_flag=True)  # pyright: ignore
@async_inject
...
@async_inject
async def create_default_roles(driver: AsyncDriverAdapterBase) -> None:
