...
from sqlstack.domain.accounts.schemas import OAuthAuthorization
...
from sqlstack.domain.accounts.auth import OAuth2AuthorizeCallback, build_oauth_error_redirect, create_oauth_state, verify_oauth_state
...
async def _handle_oauth_login(
    ...
    Returns the redirect path for the response.
    """
    from sqlstack.domain.accounts.auth import create_access_token
