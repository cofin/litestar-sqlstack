...
def find_listeners_in_module(module: object) -> list["Listener"]:
    ...
    Returns:
        List of Listener instances defined in the module.
    """
...
def _discover_listeners_in_submodule(listener_module_path: str) -> list["Listener"]:
...
def discover_domain_listeners(
    ...
    Returns:
        List of discovered Listener instances.
    """
