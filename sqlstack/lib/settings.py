...
class Settings:
    ...
    def list_all_config(self) -> dict[str, dict[str, Any]]:
        ...
        for section_name in ("app", "db", "etl", "log", "email", "task", "vite"):
    ...
    def from_env(cls, dotenv_filename: str = ".env") -> Settings:
        ...
        settings = Settings(app=app, db=db, etl=etl, log=log, email=email, task=task, vite=vite)
