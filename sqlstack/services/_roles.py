...
class RoleService(SQLSpecService):
    ...
    async def update(self, role_id: UUID, data: schemas.RoleUpdate) -> schemas.Role:
        ...
        return await self.driver.select_one(db_manager.get_sql("update-role"), update_data, schema_type=schemas.Role)
    ...
    async def fetch_with_count(self, *filters: StatementFilter) -> OffsetPagination[schemas.Role]:
        ...
        return await self.paginate(db_manager.get_sql("list-roles"), *filters, schema_type=schemas.Role)
    ...
    async def get_default_role(self) -> schemas.Role:
        ...
        return await self.driver.select_one(db_manager.get_sql("get-default-user-role"), schema_type=schemas.Role)
    ...
    async def get_active_roles(self, limit: int = 10) -> list[schemas.Role]:
        ...
        return await self.driver.select(db_manager.get_sql("get-active-roles"), limit=limit, schema_type=schemas.Role)
