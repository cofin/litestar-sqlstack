...
from sqlstack.schemas._password import PasswordStrengthAnalysis
...
class PasswordValidationError(ApplicationClientError):
    """Exception raised when password validation fails."""


class PasswordService(SQLSpecService):
